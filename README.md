...
## v4 Chiller and External Validation Extension

This bundle includes dedicated **Chiller Calculation** and **External Published Validation** tabs, a configurable `FOULING_COP_BETA`, load-normalized LBNL chiller-plant fouling validation metrics, beta calibration, and a stable union-schema memory-safe CSV writer. See `README_EXTERNAL_VALIDATION_V4.md` for details.
